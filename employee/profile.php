        ...
        <div class="card">
            ...
            <div class="info-grid">
                ...
                <div class="info-item">
                    ...
                    <p><?php echo htmlspecialchars($employee['DATE_EMP']); ?></p>
                </div>
                <div class="info-item">
                    <h3 class="font-semibold">Adresse</h3>
                    <p><?php echo htmlspecialchars($employee['ADRESSE_EMP']); ?></p>
                </div>
                <div class="info-item">
                    <h3 class="font-semibold">DATE_EMBAUCHE</h3>
                    <p><?php echo htmlspecialchars($employee['DATEEMBAUCH_EMP']); ?></p>
                </div>
                <div class="info-item">
                    <h3 class="font-semibold">NOM UTILISATEUR</h3>
                    <p><?php echo htmlspecialchars($employee['NOM_UTILISATEUR']); ?></p>
                </div>
                <div class="info-item">
                    <h3 class="font-semibold">MOT DE PASSE</h3>
                    <p><?php echo htmlspecialchars($employee['MOT_DE_PASSE']); ?></p>
                </div>
            </div>
        </div>
